...
$(document).ready(function(){
        $('#cpf').mask('000.000.000-00', {reverse: true});
        $('#arrais').mask('0-000.000/0', {reverse: true});
        isLoggedIn() ? updateClientesTable() : window.location.href = "login.html";
});
